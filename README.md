...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tool-Parrot OS-red" />
...
pkg install git -y
```
- just clone this github repository ðŸ”¥
```powershell
...
##
<p align="center">
  <a href="https://play.google.com/store/apps/details?id=com.realvnc.viewer.android"><img src="assets/vnc.jpg" height="27px" width="120px" margin="15px" /> 
  </a>
...
### open in cloud shell
<a href="https://shell.cloud.google.com/cloudshell/open?cloudshell_git_repo=https://github.com/Cyber-Tech0/Parrot-OS.git&tutorial=README.md" target="_blank"><img src="https://gstatic.com/cloudssh/images/open-btn.svg"></a>
